...
- Account deletion removes account data, historical retired-provider records, attendance and local analytics. A pseudonymous suppression marker prevents delayed analytics writes from restoring erased activity. No remote analytics or provider calls occur.
