...
export type Fit = { status: "free" | "conflict" | "unknown"; reason: string };
...
export function demoEvents(now = DateTime.now()): CampusEvent[] {
...
export const demoProfile: Profile = {
  ...emptyProfile,
  name: "Alex",
  interests: ["Outdoors", "Arts & music", "Food & fun"],
  onboarded: true,
  recurring: Array.from({ length: 7 }, (_, i) => ({
    id: `sample-${i}`,
    weekday: i + 1,
    start: "17:00",
    end: "22:00",
