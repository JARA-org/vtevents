...
const edges = {
  ...
  "public-page-parser.ts": ["domain", "public-prose", "research-sheet"],
  "research-sheet.ts": [],
  "public-prose.ts": [],
  "public-ingestion.ts": ["public-page-parser", "sources", "sports-source", "domain"],
  "sports-source.ts": [],
  "event-consolidation.ts": [],
  "agent-policy.ts": [],
  "ans-verification.ts": [],
  ...
  "assistant.ts": ["domain", "agent-policy", "public-memory", "assistant-state", "semantic-runtime"],
  "semantic-search.ts": [],
  "semantic-embedding.ts": [],
  "semantic-store.ts": ["store"],
  "semantic-runtime.ts": ["semantic-search", "semantic-embedding", "semantic-store"],
  ...
  "jobs.ts": ["coordinator", "semantic-runtime"],
  "contract-check.ts": [
    "domain",
    "coordinator",
    "sources",
