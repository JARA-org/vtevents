...
const edges = {
  ...
  "server.ts": ["store", "app", "config", "jobs", "analytics"],
  "domain.ts": [],
  "config.ts": [],
  "security.ts": [],
  "store.ts": ["config"],
  ...
  "discord.ts": ["store", "config", "security", "discord-policy"],
  "discord-policy.ts": ["store", "config", "security"],
  "narration.ts": ["domain", "store", "config"],
  "analytics.ts": ["store", "security", "config"],
  "jobs.ts": ["store", "integrations", "discord", "coordinator", "analytics"],
  "contract-check.ts": [
    "narration",
    "discord-policy",
    "domain",
